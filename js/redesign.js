/* ============================================================
   ...
   v5: portrait (no forced rotation), sticky impressed,
       fullscreen button, freeze guard.
   ============================================================ */
(function(){
  const PROF_BY_ANGER = [
  ...
  function setProfByAnger(){
    if(Date.now() < impressedUntil) return;
  ...
  /* fullscreen button (Android hides bars; iOS keeps everything fitted) */
  ...
  /* cinematic start (portrait — no forced rotation) */
